    ...
    text-align: center;"><?= T('Express Checkout'); ?><br><?php $ksdk->echoPaypalCheckoutButton(); ?></div>
		...
		<div class='kform_layout2Col kform_layout2Col_L'>
            ...
            <div class="all-fields-required">
                <span>*</span><span><?= T('All fields are required to ship your order'); ?>&nbsp;<?= T('correctly'); ?>&nbsp;</span> <i class="fa fa-check"></i>
            </div>
				...
				<h3> <?= T('Billing Address'); ?></h3>				<div class='kform_spacer'>
			...
			<div class='kform_layout2Col  kform_layout2Col_R'>
                ...
                <button class='kform_submitBtn' id='kformSubmit'><?= T('Complete Order'); ?>  <i class="fa fa-arrow-circle-right"></i></button>
